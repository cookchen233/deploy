...
start_pid=$!
if docker run -d --name 3x-ui --restart unless-stopped -p 2053:2053 -p 10000-60000:10000-60000 swr.cn-north-4.myhuaweicloud.com/ddn-k8s/ghcr.io/mhsanaei/3x-ui:v2.3.10 >/dev/null 2>&1; then
